  ...
  it('should send release information', (done: Mocha.Done) => {
    runTest(test('withAll.js'), done, (tr) => {
      ...
      assertInConsole(
        ...
        `Release-info sent: {"application":{"id":"1"},"autoCreateVersion":true,"sendNotification":true,"versionDescription":"Generated by Azure","versionName":"ECOM-11.2","startDate":"2023-01-24T12:10:00Z","releaseDate":"2023-11-02T09:30:00Z","released":true,"scope":{"issueKeys":["TEM-10","TEM-100"],"jql":"project = \\"ECP\\" and key in (ECP-288, ECP-287)"}}`
      )
    })
  })
