...
tmr.setInput('deploymentDescription', 'Generated by Azure')
// force to wrong format to mimic azure bug which convert date when returned by getInput
tmr.setInput('deploymentDeployedOn', '01/24/2023 12:10:00')
tmr.setInput('autoCreateVersion', 'true')
tmr.setInput('deploymentIssueKeys', 'TEM-10,TEM-100')
tmr.setInput('deploymentJql', `project = "ECP" and key in (ECP-288, ECP-287)`)
