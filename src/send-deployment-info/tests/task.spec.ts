  ...
  it('should send deployment information', (done: Mocha.Done) => {
    runTest(test('withAll.js'), done, (tr) => {
      ...
      assertInConsole(
        ...
        `Deployment-info sent: {"environment":{"id":"1"},"autoCreateVersion":true,"sendNotification":true,"deployedOn":"2023-01-24T12:10:00Z","scope":{"issueKeys":["TEM-10","TEM-100"]},"versionName":"ECOM-11.2","description":"Generated by Azure"}`
      )
    })
  })
